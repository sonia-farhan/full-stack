...
export const getProductController = AsyncModule(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, product, "Product Access Successfully"));
});
...
export const getAllProductController = AsyncModule(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, product, "All products list are here"));
});
...
export const filterProductController = AsyncModule(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, product, "product filter successfully"));
  return res
    .status(200)
    .json(new ApiResponse(200, product, "Product cannot filter Successfully"));
});
...
export const similarProductController = AsyncModule(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, products, "Product Found successfully"));
});
